...
public class QuestionController {
    ...
    public @ResponseBody
    String title_uploadImg(HttpServletRequest request, HttpServletResponse response) {

        String imagedata = request.getParameter("image").split("base64,")[1];
        String image_path = request.getSession().getServletContext().getRealPath("/resources/images/upload/");
        System.out.println(request.getSession().getServletContext().getContextPath());
        String imageType = request.getParameter("image").split(";")[0].split("/")[1];
...
//        String time=System.currentTimeMillis()+".jpg";
        ...
        String filepath = image_path + time;
//        System.out.println(imagedata);
//        System.out.println(filepath);
        System.out.println("图片添加" + GenerateImage(imagedata, filepath));
        return time;
    }
